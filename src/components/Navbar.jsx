...
export default function Navbar() {
  ...
  className="rounded-xl border border-white/10 bg-white/6 px-3 py-2 text-sm font-medium text-zinc-100/88 backdrop-blur-md transition duration-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.10),0_8px_20px_rgba(0,0,0,0.16)] hover:border-amber-100/20 hover:bg-white/10 hover:text-amber-50/90"
>
  Who am I?
</button>
